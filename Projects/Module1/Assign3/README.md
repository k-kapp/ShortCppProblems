Implementation of a generalised genetic algorithm. The user of this program may specify from the command line the population size, number of dimensions and stopping criteria.
